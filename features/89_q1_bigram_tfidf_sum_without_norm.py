...
from features.transform import nltk_stemming_without_stopwords, nltk_tokenize
...
class WordMatchCount(RowWiseFeatureCreatorBase):
    def __init__(self, options):
        ...
        self.vectorizer = TfidfVectorizer(max_df=0.5, min_df=8, ngram_range=(5, 5), analyzer='char')
    ...
    def read_data(self, data_file):
        return np.array(self.vectorizer.transform(nltk_stemming_without_stopwords(data_file)['question1']
