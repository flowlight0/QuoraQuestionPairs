...
class WordMatchCount(RowWiseFeatureCreatorBase):
    def __init__(self, options):
        ...
        self.vectorizer = TfidfVectorizer(max_df=0.5, min_df=8, ngram_range=(3, 3), binary=True, stop_words=["'s"])
    ...
    def read_data(self, data_file):
        return np.array(self.vectorizer.transform(nltk_stemming(data_file)['question1']
