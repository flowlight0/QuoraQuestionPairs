...
class DepthLimiter:
    ...
    def calculate_row_feature(self, q1, q2):
        ...
        return {
            'dep_depth_limit_in_q1_words_ratio_glove': len(filtered_q1) / len(limit_q1),
            'dep_depth_limit_in_q2_words_ratio_glove': len(filtered_q2) / len(limit_q2),
            'dep_depth_limit_wmd_glove': self.model.wmdistance(filtered_q1, filtered_q2)
        }
