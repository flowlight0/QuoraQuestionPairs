...
class FeatureCreator(RowWiseFeatureCreatorBase):
    def __init__(self, options):
        ...
        self.vectorizer = TfidfVectorizer(max_df=0.5, min_df=6, ngram_range=(1, 1))
    ...
    def read_data(self, data_file):
        ...
        X2 = self.vectorizer.transform(nltk_stemming_without_stopwords(data_file)['question2'].fillna("").tolist())
        return [(X1.getrow(i), X2.getrow(i)) for i in range(X1.shape[0])]
