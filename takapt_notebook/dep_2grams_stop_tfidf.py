...
creator = DependencyNgramsCreator(n=2, skip_stopwords=True)
...
def main():
    ...
    train_feature['dep_2grams_stop_sum_tfidf_q1'] = train_q1_tfidf.sum(axis=1)
    train_feature['dep_2grams_stop_sum_tfidf_q2'] = train_q2_tfidf.sum(axis=1)
    train_feature['dep_2grams_stop_tfidf_cosine'] = np.array(train_q1_tfidf.multiply(train_q2_tfidf).sum(axis=1)).reshape(-1)
    train_feature.to_pickle(os.path.join(output_path, 'train_dep_2grams_stop_tfidf.pkl'))
    ...
    test_feature['dep_2grams_stop_sum_tfidf_q1'] = test_q1_tfidf.sum(axis=1)
    test_feature['dep_2grams_stop_sum_tfidf_q2'] = test_q2_tfidf.sum(axis=1)
    test_feature['dep_2grams_stop_tfidf_cosine'] = np.array(test_q1_tfidf.multiply(test_q2_tfidf).sum(axis=1)).reshape(-1)
    test_feature.to_pickle(os.path.join(output_path, 'test_dep_2grams_stop_tfidf.pkl'))
